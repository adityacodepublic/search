...
export async function elasticSearchV2(query: string): Promise<any> {
...
export async function elasticSemanticSearchV2(query: string): Promise<any> {
...
export async function elasticHybridSearchV2(query: string): Promise<any> {
